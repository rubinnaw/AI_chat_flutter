...
- `lib/` - Основной код приложения
  ...
  - `screens/` - Экраны приложения
    - `api_key_screen.dart` - Стартовый экран для ввода API key
    - `chat_screen.dart` - Основной экран чата
    - `expenses_graph_screen.dart` - Экран статистики расходов с графиком
    - `settings_screen.dart` - Экран настройки API
    - `statistics_screen.dart` - Основной экран статистики
  - `utils/` - Вспомогательные модули
    - `api_storage.dart` - Локальное хранение настроек API
...
3. При первом запуске добавьте свой API ключ (OpenRouter или VseGPT)
